            ...
            <div className="gradient-hero p-6 text-white">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-white/60 text-sm">Class 10 • CBSE</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6">
              ...
              <div className="p-4 rounded-xl bg-blue-50 border border-blue-100">
                ...
                <p className="text-sm text-blue-800 leading-relaxed">
                  &quot;Rohit ne is hafte bahut achha kiya! 📈 Algebra mein
                  kaafi improvement hai. Trigonometry pe thoda aur practice
                  chahiye. Overall great progress!&quot;
                </p>
              </div>
            </div>
          </div>
